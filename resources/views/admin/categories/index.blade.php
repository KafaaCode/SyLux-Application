...
<div class="content-header row">
    <div class="content-header-left col-md-9 col-12 mb-2">
        <div class="row breadcrumbs-top">
            <div class="col-12">
                <h2 class="content-header-title float-left mb-0" style="color: #70B9BE; font-weight: bold;">إدارة الفئات</h2>
            ...
            <div class="card-header">
                ...
                <div class="card-tools">
                    ...
                    <form method="GET" action="{{ route('admin.categories.index') }}" class="d-flex align-items-center gap-2">
                        ...
                        <select name="country_id" class="form-control form-control-sm" style="width: 150px;">
                        ...
                        <select name="specialization_id" class="form-control form-control-sm" style="width: 150px;">
