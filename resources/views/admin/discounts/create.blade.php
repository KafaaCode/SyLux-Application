...
<div class="content-header row mb-2">
    <div class="col-12">
        <h2 class="content-header-title" style="color: #B79C6D;">إضافة خصم جديد</h2>
    </div>
</div>
            ...
            <div class="row">
                ...
                <div class="col-md-12 mb-3">
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" name="apply_to_all" id="apply_to_all" value="1">
                        <label class="form-check-label" for="apply_to_all">تطبيق على جميع المنتجات</label>
                    </div>
                </div>
                <div class="col-md-12 mb-3" id="products_container">
